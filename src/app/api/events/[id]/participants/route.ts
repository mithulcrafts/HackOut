...
export async function GET(_request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    summary: {
      ...
      renewableAlignedConsumptionKWh: report.renewableAlignedConsumptionKWh,
      peakReductionKW: report.peakReductionKW,
      peakReductionPercent: report.peakReductionPercent,
      participantCount: report.participantCount,
      rewardCost: report.rewardCost,
      pendingRewardCost: report.pendingRewardCost,
      disputedActivities: report.disputedActivities,
      acceptanceRate: report.acceptanceRate,
      unresolvedGapKW: report.unresolvedGapKW,
    },
