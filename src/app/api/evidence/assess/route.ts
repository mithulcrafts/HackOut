...
export async function POST(request: Request) {
  ...
  return errorResponse("This account has no approved meter or charger adapter yet. Uploads are retained for review only; the hackathon demo uses the clearly labelled simulator.", 501);
}
