...
export async function POST(request: Request) {
  ...
  if (demo && (process.env.NODE_ENV !== "production" || process.env.DEMO_MODE === "true")) {
    ...
    redeemDemo(demo, parsed.data.rewardId); return NextResponse.json({ message: "Reward marked redeemable in this account. No real payment was made." });
  }
  ...
  return NextResponse.json({ message: "Reward marked redeemable in this account. No real payment was made." });
}
