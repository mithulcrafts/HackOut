...
import { dispatchBattery, classifyBalance } from "@/domain/scheduling/engine";
...
export default async function OverviewPage() {
  ...
  return <OperatorDashboard scenario={scenario} summary={summarizeScenario(scenario)} balances={balances} battery={battery} />;
}
