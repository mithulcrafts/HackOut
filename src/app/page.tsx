...
export default function Home() {
  return (
    <main className="app-shell">
      ...
      <nav className="bottom-nav" aria-label="Primary navigation"><a className="active" href="#today"><CircleGauge size={19} /><span>Today</span></a><Link href="/consumer/activities"><Zap size={19} /><span>Activities</span></Link><a href="/login"><Sparkles size={19} /><span>Rewards</span></a></nav>
    </main>
  );
}
