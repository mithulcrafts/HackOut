      ...
      <div className="container" style={{ paddingTop: 40 }}>
        ...
        <div className="card">
          ...
          <div className="grid two-col">
            ...
            <label className="filter-control">Illustrative reward rate (₹/kWh)<input type="number" min={0} step={0.1} value={rate} onChange={(e) => { setRate(Number(e.target.value)); setPreview(null); }} /></label>
