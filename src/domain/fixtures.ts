...
export function createDemoScenario(): Scenario {
  ...
  const scenario: Scenario = {
    id: "scenario-demo-2026-09-12",
    date: "2026-09-12",
    timezone: "Asia/Kolkata",
    sitePowerLimitKW: 18,
    rewardRatePerKWh: 1.5,
    forecast,
    activities,
    schedules,
    offers: [],
    events: [
      {
        id: "event-absorb-demo",
        name: "Midday renewable absorption",
        objective: "absorb",
        status: "draft",
        windowStart: 26,
        windowEnd: 34,
        requestedFlexibilityKW: 10,
        eligibleActivityTypes: ["ev", "water_heater", "industrial_process", "washing_machine", "dishwasher", "irrigation_pump", "pool_pump", "cold_storage", "e_bike", "custom"],
        rewardRatePerKWh: 1.5,
        budget: 250,
        offerExpiresAt: "2026-09-12T16:00:00+05:30",
        frozenBaselineVersion: 1,
      },
      {
        id: "event-protect-demo",
        name: "Evening peak protection",
        objective: "protect",
        status: "draft",
        windowStart: 34,
        windowEnd: 40,
        requestedFlexibilityKW: 8,
        eligibleActivityTypes: ["ev", "water_heater", "industrial_process", "washing_machine", "dishwasher", "irrigation_pump", "pool_pump", "cold_storage", "e_bike", "custom"],
        participantGroup: "All enrolled participants",
        rewardRatePerKWh: 2,
        budget: 180,
        offerExpiresAt: "2026-09-12T17:00:00+05:30",
        frozenBaselineVersion: 1,
      },
    ],
    readings: [],
    battery: { capacityKWh: 40, currentKWh: 22, maxChargeKW: 8, maxDischargeKW: 8, roundTripEfficiency: 0.9 },
    mode: "absorb",
