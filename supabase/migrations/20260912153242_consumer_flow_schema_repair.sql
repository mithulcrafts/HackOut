-- Preserve earlier development-only tables before installing the current contract.
alter table if exists public.offers rename to legacy_offers;
alter table if exists public.meter_readings rename to legacy_meter_readings;
alter table if exists public.verifications rename to legacy_verifications;
alter table if exists public.reward_ledger rename to legacy_reward_ledger;
